...
TEST (hashTableTest, isPermutation)
{
    std::string word1 = "abcd";
    std::string word2 = "dbca";
    ASSERT_TRUE(checkPermutations_hashTable(word1, word2));
    word1 = "q2b2";
    word2 = "2b2q";
    ASSERT_TRUE(checkPermutations_hashTable(word1, word2));
}

TEST (hashTableTest, notPermutation)
{
    std::string word1 = "acd";
    std::string word2 = "dbca";
    ASSERT_FALSE(checkPermutations_hashTable(word1, word2));
    word1 = "qa";
    word2 = "aa";
    ASSERT_FALSE(checkPermutations_hashTable(word1, word2));
}
